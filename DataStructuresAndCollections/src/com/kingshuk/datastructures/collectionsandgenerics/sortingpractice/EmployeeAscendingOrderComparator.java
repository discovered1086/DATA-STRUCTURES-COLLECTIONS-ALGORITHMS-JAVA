...
public class EmployeeAscendingOrderComparator implements Comparator<Employee>{
	
	/**
	 * Here what we're essentially saying in the method is that
	 * 
	 * I'm trying to order the employees in ascending order of their employee
	 ...
	 * come later, and we know that "later or after means positive" that's why we're returning
	 * a positive integer value
	 * 
	 * 2) If o1's employee id is smaller than o2's employee id then o1 should come before o2
	 * (because this class sorts based on descending order of employee ids) and we know 
	 * "before means negative" that's why we're returning a negative integer value
	 * 
